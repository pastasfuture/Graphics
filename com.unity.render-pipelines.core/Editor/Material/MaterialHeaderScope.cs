...
namespace UnityEditor.Rendering
{
    ...
    public struct MaterialHeaderScope : IDisposable
    {
        ...
        public MaterialHeaderScope(GUIContent title, uint bitExpanded, MaterialEditor materialEditor, bool spaceAtEnd = true, Color colorDot = default, bool subHeader = false, uint defaultExpandedState = uint.MaxValue)
        {
        ...
        [Obsolete("Use a `GUIContent` instead of a string", false)]
